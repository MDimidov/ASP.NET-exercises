...
{
    /// <inheritdoc />
    public partial class InserEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Product application user identifier"),
                    AddedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Product date of creation"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Product category identifier"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "Product is deleted")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Application user identifier")
                },
                constraints: table =>
                {
